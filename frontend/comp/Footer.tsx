...
export default function Footer() {
    ...
    return (
        <footer className="bg-white border-t border-gray-200 mt-auto animate-fade-in">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16">
                {/* Main Footer Content */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8">
                    {/* Shop Info */}
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-[#1d1d1f] tracking-tight">{footerData.shopName}</h3>
                        <p className="text-sm text-[#86868b] leading-relaxed">
                            A curated selection of the world's best essentials. Designed for the way you live.
                        </p>
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2 text-sm text-[#86868b]">
                                ...
                                <a href={`tel:${footerData.phone}`} className="hover:text-[#0071e3] transition-colors">
                                    {footerData.phone}
                                </a>
                            </div>
                            <div className="flex items-center gap-2 text-sm text-[#86868b]">
                                <Mail size={16} className="flex-shrink-0" />
                                <a href={`mailto:${footerData.email}`} className="hover:text-[#0071e3] transition-colors">
                                    {footerData.email}
                                </a>
                            </div>
                        </div>
                    ...
                    {/* Support Links */}
                    <div>
                        <h4 className="font-semibold text-[#1d1d1f] mb-4">Support</h4>
                        <ul className="space-y-2">
                ...
                <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-[#86868b]">
                        © {currentYear} {footerData.shopName}. All rights reserved.
                    </p>
